...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 27, 2022 at 01:58 PM
...
(
  ...
  FOREIGN KEY wishlistitem(id) REFERENCES wishlist(id),
  FOREIGN KEY wishlistitem(productid) REFERENCES product(mid)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
--
ALTER TABLE `cartitem`
  ADD CONSTRAINT `cartitem_ibfk_1` FOREIGN KEY (`productid`) REFERENCES `product` (`mid`),
  ADD CONSTRAINT `cartitem_ibfk_2` FOREIGN KEY (`id`) REFERENCES `cart` (`id`);
