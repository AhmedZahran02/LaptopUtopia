...
ALTER TABLE `brand` ADD PRIMARY KEY (`name`,`workfield`);
...
ALTER TABLE `cpu` ADD PRIMARY KEY (`mid`);
...
ALTER TABLE `gpu` ADD PRIMARY KEY (`mid`);
...
ALTER TABLE `ram` ADD PRIMARY KEY (`mid`);
...
ALTER TABLE `storage` ADD PRIMARY KEY (`mid`);
...
ALTER TABLE `cartitem` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE
    `complaint` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE
    `orderitem` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE
    `signinlog` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE
    `wishlistitem` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ADD
    CONSTRAINT `customer_ibfk_2` FOREIGN KEY (`wishlistid`) REFERENCES `wishlist` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;
...
ADD
    CONSTRAINT `laptop_ibfk_2` FOREIGN KEY (`cpuid`) REFERENCES `cpu` (`mid`) ON DELETE NO ACTION ON UPDATE CASCADE,
ADD
    CONSTRAINT `laptop_ibfk_3` FOREIGN KEY (`gpuid`) REFERENCES `gpu` (`mid`) ON DELETE NO ACTION ON UPDATE CASCADE,
ADD
    CONSTRAINT `laptop_ibfk_4` FOREIGN KEY (`ramid`) REFERENCES `ram` (`mid`) ON DELETE NO ACTION ON UPDATE CASCADE,
ADD
    CONSTRAINT `laptop_ibfk_5` FOREIGN KEY (`storageid`) REFERENCES `storage` (`mid`) ON DELETE NO ACTION ON UPDATE CASCADE;
